...
pub mod basemail_account {
        ...
        ::ethers::core::abi::ethabi::Contract {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        ...
                        inputs: ::std::vec![
                            ...
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("usernameToTransfer_",),
                                kind: ::ethers::core::abi::ethabi::ParamType::String,
                                internal_type: ::core::option::Option::Some(
                                    ::std::borrow::ToOwned::to_owned("string"),
                                ),
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                        name: ::std::borrow::ToOwned::to_owned("AccountBalanceOverflow",),
                        inputs: ::std::vec![],
                    },],
                ),
                (
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                        name: ::std::borrow::ToOwned::to_owned("BalanceQueryForZeroAddress",),
                        inputs: ::std::vec![],
                    },],
                ),
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                        name: ::std::borrow::ToOwned::to_owned("NotOwnerNorApproved",),
                        inputs: ::std::vec![],
                    },],
                ),
                (
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                        name: ::std::borrow::ToOwned::to_owned("TransferFromIncorrectOwner",),
                        inputs: ::std::vec![],
                    },],
                ),
                (
                    ::std::borrow::ToOwned::to_owned("TransferToNonERC721ReceiverImplementer"),
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::AbiError {
                        name: ::std::borrow::ToOwned::to_owned("TransferToZeroAddress",),
                        inputs: ::std::vec![],
                    },],
                ),
                (
    ...
    pub static BASEMAILACCOUNT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static BASEMAILACCOUNT_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static BASEMAILACCOUNT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> BasemailAccount<M> {
        ...
        pub fn transfer_username(
            ...
            self.0
                .method_hash([224, 30, 207, 75], (to, username_to_transfer, new_username))
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn account_deleted_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, AccountDeletedFilter>
        {
            self.0.event()
        }
        ...
        pub fn username_changed_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, UsernameChangedFilter>
        {
            self.0.event()
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, BasemailAccountEvents>
        {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for BasemailAccountErrors {
        fn decode(
            ...
            if let Ok(decoded) =
                <AccountBalanceOverflow as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <BalanceQueryForZeroAddress as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::BalanceQueryForZeroAddress(decoded));
            }
            if let Ok(decoded) =
                <NotOwnerNorApproved as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::NotOwnerNorApproved(decoded));
            }
            if let Ok(decoded) = <OnlyTokenHolder as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::OnlyTokenHolder(decoded));
            }
            if let Ok(decoded) =
                <TokenAlreadyExists as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TokenAlreadyExists(decoded));
            }
            if let Ok(decoded) = <TokenDoesNotExist as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TokenDoesNotExist(decoded));
            }
            if let Ok(decoded) =
                <TransferFromIncorrectOwner as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <TransferToZeroAddress as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::TransferToZeroAddress(decoded));
            }
            if let Ok(decoded) = <UsernameInvalid as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for BasemailAccountErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::OnlyTokenHolder(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::TokenAlreadyExists(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::TokenDoesNotExist(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::UsernameInvalid(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for BasemailAccountErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::AccountBalanceOverflow(element) => ::core::fmt::Display::fmt(element, f),
                Self::AccountDoesNotExist(element) => ::core::fmt::Display::fmt(element, f),
                Self::BalanceQueryForZeroAddress(element) => ::core::fmt::Display::fmt(element, f),
                Self::NotOwnerNorApproved(element) => ::core::fmt::Display::fmt(element, f),
                Self::OnlyTokenHolder(element) => ::core::fmt::Display::fmt(element, f),
                Self::TokenAlreadyExists(element) => ::core::fmt::Display::fmt(element, f),
                Self::TokenDoesNotExist(element) => ::core::fmt::Display::fmt(element, f),
                Self::TransferFromIncorrectOwner(element) => ::core::fmt::Display::fmt(element, f),
                Self::TransferToNonERC721ReceiverImplementer(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::TransferToZeroAddress(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<TransferToNonERC721ReceiverImplementer> for BasemailAccountErrors {
    ...
    #[ethevent(
        name = "AccountCreated",
        abi = "AccountCreated(uint256,address,string)"
    )]
    ...
    #[ethevent(
        ...
        abi = "UsernameChanged(uint256,string,string)"
    )]
    ...
    impl ::core::fmt::Display for BasemailAccountEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::AccountDeletedFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ApprovalFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ApprovalForAllFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::TransferFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::UsernameChangedFilter(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for BasemailAccountCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <ChangeUsernameCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <DeleteAccountCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::DeleteAccount(decoded));
            }
            if let Ok(decoded) = <GetAccountIdCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetAccountId(decoded));
            }
            if let Ok(decoded) = <GetAccountsCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) = <GetUsernameCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetUsername(decoded));
            }
            if let Ok(decoded) = <GetUsernamesCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::GetUsernames(decoded));
            }
            if let Ok(decoded) =
                <HolderAccountsCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::HolderAccounts(decoded));
            }
            if let Ok(decoded) = <IdCounterCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::IdCounter(decoded));
            }
            if let Ok(decoded) = <IdToNameCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) = <NameToIdCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) =
                <TransferUsernameCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for BasemailAccountCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::ChangeUsername(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::CreateAccount(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::DeleteAccount(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetAccountId(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetAccounts(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetApproved(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetUsername(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::GetUsernames(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::HolderAccounts(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::IdCounter(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::IdToName(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::IsApprovedForAll(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::Name(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::NameToId(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::TransferUsername(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
    ...
    impl ::core::convert::From<SafeTransferFromWithFromAndToAndDataCall> for BasemailAccountCalls {
